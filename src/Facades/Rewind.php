 ...
 * @method static int goTo(Model $model, int $version) Jump to a specific version, returns version number
 * @method static Model cloneModel(Model $model, int $version) Clone a model at a specific version
